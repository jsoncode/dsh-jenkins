...
function openStore(raw: string, key: Buffer | null): JenkinsStore {
  const parsed = JSON.parse(raw) as { version?: number; servers?: unknown; cache?: unknown }
 ...
 */
export async function loadStore(dir: string): Promise<JenkinsStore | null> {
