...
const COPY = {
	zh: {
		...
		projectNone: "暂无",
		selectConfig: "选择配置",
		selectConfigHint: "打开文件管理器，选择一个 dsh-jenkins 配置文件（json/js/ts）来初始化下方表单参数",
		configPickLoading: "解析中…",
		configParseFailed: "配置文件解析失败",
		configEmptyEntries: "配置文件中没有有效的发布目标",
		configSourceLabel: "已选配置",
		configClear: "清除",
		configTargetCount: "{n} 个发布目标",
	...
	en: {
		...
		selectConfigHint: "Open the file manager and pick a dsh-jenkins config file (json/js/ts) to initialize the form below",
		configPickLoading: "Parsing…",
		configParseFailed: "Failed to parse config file",
		configEmptyEntries: "No valid publish targets in the config file",
		configSourceLabel: "Selected config",
		configClear: "Clear",
		configTargetCount: "{n} targets",
...
function PublishTab({ initialCwd, sessionId, run, poller, storage, workspaceItems, onCountChange, onFooter, onOpenLog }) {
	...
	const [projectConfig, setProjectConfig] = (0, react.useState)(null);
	const [fileConfig, setFileConfig] = (0, react.useState)(null);
	...
	const onPickFile = (0, react.useCallback)((e) => {
		const file = e.target.files && e.target.files[0];
		e.target.value = "";
		if (!file) return;
		setConfigLoading(true);
		setConfigError("");
		file.text().then((text) => run(sessionId, {
			op: "configParseContent",
			filename: file.name,
			content: text
		})).then((r) => {
			const cfg = r && r.config;
			if (r && r.ok && cfg && Array.isArray(cfg.entries) && cfg.entries.length > 0) setFileConfig({
				name: file.name,
				config: cfg
			});
			else {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: configLoading ? t("configPickLoading") : t("selectConfig")
					})
				]
			}),
			fileConfig ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dshj-config-source",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					className: "dshj-config-source-text",
					children: [
						t("configSourceLabel"),
						"：",
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dshj-config-source-path",
							children: fileConfig.name
						}),
						" · ",
						t("configTargetCount", { n: fileConfig.config.entries.length })
					]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
			...
			}) : configError ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dshj-config-source",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: "dshj-err",
...
function LauncherContent({ cwd, configCwd, sessionId, config, run, poller, storage, onCountChange, onFooter, onOpenLog }) {
	...
	const onSubmit = async () => {
		...
		try {
			const res = config && configCwd ? await run(sessionId, {
				op: "workspaceTrigger",
				cwd,
				configCwd,
