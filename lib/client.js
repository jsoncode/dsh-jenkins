...
const css = [
	...
	".dshj-config-modal{width:min(880px,100%);height:min(80vh,720px);min-height:480px}",
...
*/
function PublishTab({ initialCwd, sessionId, run, poller, storage, workspaceItems }) {
	...
	const [projectPickOpen, setProjectPickOpen] = (0, react.useState)(false);
	const [projectPickSearch, setProjectPickSearch] = (0, react.useState)("");
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				onClick: () => {
					setProjectPickSearch("");
					setProjectPickOpen(true);
				},
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: "dshj-picker-value",
					children: project ? project : paths.length === 0 ? t("noWorkspacesHint") : t("projectPlaceholder")
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PickerModal, {
				...
				options: paths.filter((p) => p.toLowerCase().indexOf(projectPickSearch.toLowerCase()) !== -1).map((p) => ({
					id: p,
					label: p
				})),
				selectedId: project || void 0,
				emptyText: paths.length === 0 ? t("noWorkspacesHint") : void 0,
				onSelect: (id) => {
					setProject(id);
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				!loading && !error ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dshj-history-ops dshj-log-ops",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "dshj-btn dshj-btn-small",
						onClick: () => void copy(),
...
*/
function HistoryTab({ cwd, sessionId, run, poller, storage, useWorkspaces }) {
	...
	const [wsPickOpen, setWsPickOpen] = (0, react.useState)(false);
	const [wsPickSearch, setWsPickSearch] = (0, react.useState)("");
	const reload = () => {
		storage.readAllHistory(sessionId).then(setList).catch(() => void 0);
	};
	(0, react.useEffect)(() => poller.subscribe(reload), [
		poller,
		storage,
		sessionId
	]);
		...
		/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PickerModal, {
					...
					options: wsOptions.filter((o) => o.label.toLowerCase().indexOf(wsPickSearch.toLowerCase()) !== -1).map((o) => ({
						id: o.id,
						label: o.label
					})),
					selectedId: filter,
