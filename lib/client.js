...
function FooterButton({ onOpen, reportSession, wide = false, useSessions, poller }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		}), showBuilding || showDone ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
			className: "dshj-footer-caps",
			children: [showBuilding ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: "dshj-capsule dshj-capsule-building",
				title: t("footerBuilding") + ": " + summary.building,
				children: summary.building
			}) : null, showDone ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
function TemplateSection({ run, sessionId, cwd }) {
...
*/
function TemplateModal({ run, sessionId, cwd, onClose }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ModalPortal, {
		backdropClass: "dshj-json-backdrop",
...
*/
function SettingsPage({ run, sessionId, cwd, onCountChange }) {
	const [servers, setServers] = (0, react.useState)([]);
