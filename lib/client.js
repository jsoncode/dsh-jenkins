...
const css = [
	...
	".dshj-tab:not(.dshj-tab-active):hover{background:var(--dsw-alias-interactive-bg-hover,rgba(128,128,128,.1))}",
...
const COPY = {
	zh: {
		...
		confirmDelete: "确认删除",
		editBtn: "编辑",
		footerOrder: "Footer 按钮排序",
		footerOrderHint: "与其他插件共存时，「Jenkins 配置」按钮在侧边栏底部的位置（自动适配其它插件的顺序，无需重启）",
		footerOrderFront: "靠前",
		footerOrderBack: "靠后",
	...
	en: {
		...
		editBtn: "Edit",
		footerOrder: "Footer button order",
		footerOrderHint: "Position of the \"Jenkins Config\" button at the sidebar foot when other plugins share it (auto-adapts to their order, no restart needed)",
		footerOrderFront: "First",
		footerOrderBack: "Last",
...
function makeFooterOrderStore() {
	...
	const useValue = () => {
		const [v, setV] = (0, react.useState)(store.value ?? "back");
		(0, react.useEffect)(() => store.subscribe(() => setV(store.value ?? "back")), []);
		return v;
	};
	return {
		store,
...
function BuildLogModal({ entry, run, sessionId, onClose, poller }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		onClick: onClose,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "dshj-modal dshj-log-modal" + (fullscreen ? " dshj-log-fullscreen" : ""),
			onClick: (e) => e.stopPropagation(),
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dshj-modal-header",
...
function HistoryTab({ cwd, sessionId, run, poller, storage, onCountChange, onFooter, logTarget: logTargetProp, onLogTargetChange }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		...
		confirmClear ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: "dshj-backdrop dshj-json-backdrop dshj-confirm-backdrop",
			onClick: () => setConfirmClear(false),
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dshj-modal dshj-confirm-modal",
				onClick: (e) => e.stopPropagation(),
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshj-modal-header",
...
//#endregion
//#region src/client/components/EntryConfigTab.tsx
/**
* dsh-jenkins —— 统一弹框「入口配置」tab：侧边栏底部入口（footer 按钮）的设置。
*/
function EntryConfigTab({ run, sessionId, footerOrderStore }) {
	const footerOrder = footerOrderStore.useValue();
	(0, react.useEffect)(() => {
		run(sessionId, { op: "footerOrderGet" }).then((r) => {
			const v = r && r.ok ? r.footerOrder : void 0;
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "dshj-card-name",
					children: t("footerOrder")
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "dshj-card-meta",
					children: t("footerOrderHint")
				})]
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dshj-card-ops",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
...
function JenkinsConfigModal({ run, poller, storage, useOpen, close, footerOrderStore, useWorkspaces, useSessions }) {
	const open = useOpen();
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					}) : tab === "entry" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ErrorBoundary, {
						label: "EntryConfigTab",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EntryConfigTab, {
							run,
							sessionId,
							footerOrderStore
						})
...
*/
function computeFooterOrder(entries, policy) {
	const orders = entries.filter((e) => e.options.id !== FOOTER_ENTRY_ID).map((e) => e.options.order ?? 0);
	...
	return {
		...
		apply(ctx) {
			...
			slots.inject(FOOTER_SLOT, () => {
				let dispose;
				let lastOrder;
				let policy = footerOrderStore.store.value ?? "back";
				const register = () => {
