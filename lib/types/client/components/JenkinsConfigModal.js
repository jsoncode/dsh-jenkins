...
export function JenkinsConfigModal({ run, poller, storage, useOpen, close, useWorkspaces, useSessions }) {
    ...
    return (_jsx("div", { className: "dshj-backdrop", children: _jsxs("div", { className: "dshj-modal dshj-config-modal", onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { className: "dshj-modal-header", children: [_jsxs("div", { children: [_jsx("div", { className: "dshj-modal-title", children: t('settingsNav') }), _jsx("div", { className: "dshj-modal-sub", children: cwd || '' })] }), _jsx("button", { type: "button", className: "dshj-close", "aria-label": t('close'), title: t('close'), onClick: close, children: "\u2715" })] }), _jsx("div", { className: "dshj-tabs", role: "tablist", children: TABS.map((item) => {
                    ...
                    }) }), _jsx("div", { className: "dshj-modal-body dshj-config-body", children: tab === 'publish' ? (_jsx(ErrorBoundary, { label: "PublishTab", children: _jsx(PublishTab, { initialCwd: cwd, sessionId: sessionId, run: run, poller: poller, storage: storage, workspaceItems: workspaceItems, onCountChange: setConfigCount }) })) : tab === 'config' ? (_jsx(ErrorBoundary, { label: "SettingsPage", children: _jsx(SettingsPage, { run: run, sessionId: sessionId, onCountChange: setConfigCount }) })) : (_jsx(ErrorBoundary, { label: "HistoryTab", children: _jsx(HistoryTab, { cwd: cwd, sessionId: sessionId, run: run, poller: poller, storage: storage, onCountChange: setHistoryCount }) })) })] }) }));
}
