...
import { EntryConfigTab } from "./EntryConfigTab.js";
const TABS = [
...
export function JenkinsConfigModal({ run, poller, storage, useOpen, close, footerOrderStore, useWorkspaces, useSessions }) {
    const open = useOpen();
