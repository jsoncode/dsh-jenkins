...
export function FooterButton({ onOpen, reportSession, wide = false, useSessions, poller }) {
    ...
    return (_jsxs("div", { className: 'dshj-footer-group' + (wide ? '' : ' dshj-footer-rail-group'), children: [_jsxs("button", { type: "button", className: 'dshj-footer-btn' + (wide ? '' : ' dshj-footer-btn-rail'), title: t('configBtn'), "aria-label": t('configBtn'), onClick: onOpen, children: [_jsx("img", { src: JENKINS_LOGO, alt: "", className: "dshj-footer-logo" }), wide ? _jsx("span", { className: "dshj-footer-label", children: t('configBtn') }) : null] }), showBuilding || showDone ? (_jsxs("span", { className: "dshj-footer-caps", children: [showBuilding ? (_jsx("span", { className: "dshj-capsule dshj-capsule-building", title: t('footerBuilding') + ': ' + summary.building, children: summary.building })) : null, showDone ? (_jsx("span", { className: "dshj-capsule dshj-capsule-done", title: t('footerDoneUnread') + ': ' + summary.successUnread, children: summary.successUnread })) : null] })) : null] }));
}
