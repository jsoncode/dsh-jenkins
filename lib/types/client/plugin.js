...
export function createPlugin() {
    return {
        ...
        apply(ctx) {
            ...
            slots.inject('sidebar.footer.action', () => slots.register({ name: 'sidebar.footer.action', id: 'dsh-jenkins', order: 10 }, (props) => (_jsx(FooterButton, { onOpen: () => configStore.open(true), reportSession: (s) => { if (s)
